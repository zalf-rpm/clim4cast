...
def write_row_to_grids(row_col_data, row, ncols, header, path_to_output_dir, path_to_csv_output_dir, setup_id):
    ...
    output_grids = {
        ...
        #"HeatRed_S1": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"HeatRed_S2": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"HeatRed_S3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"HeatRed_S4": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"HeatRed_S5": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"HeatRed_S6": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"OxRed_S1": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"OxRed_S2": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"OxRed_S3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"OxRed_S4": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"OxRed_S5": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"OxRed_S6": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"FrostRed": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"FrostRed_S1": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"FrostRed_S2": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"FrostRed_S3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"FrostRed_S4": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"FrostRed_S5": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"FrostRed_S6": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"Nstress": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Nstress_S1": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Nstress_S2": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Nstress_S3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Nstress_S4": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Nstress_S5": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        "Nstress_S6": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"ETa_ETc_S1": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"ETa_ETc_S2": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"ETa_ETc_S3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"ETa_ETc_S4": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"ETa_ETc_S5": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"ETa_ETc_S6": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        ...
        #"Pwp_S2": {"data": make_dict_nparr(), "cast-to": "float", "digits": 3},
        #"Pwp_S3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 3},
        #"Pwp_S4": {"data": make_dict_nparr(), "cast-to": "float", "digits": 3},
        #"Pwp_S5": {"data": make_dict_nparr(), "cast-to": "float", "digits": 3},
        #"Pwp_S6": {"data": make_dict_nparr(), "cast-to": "float", "digits": 3},
        #"rootingZone_S1": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"rootingZone_S2": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"rootingZone_S3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"rootingZone_S4": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"rootingZone_S5": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"rootingZone_S6": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"Fc_S1": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"Fc_S2": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"Fc_S3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"Fc_S4": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"Fc_S5": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"Fc_S6": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"PASW_S1": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"PASW_S2": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"PASW_S3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"PASW_S4": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"PASW_S5": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
        #"PASW_S6": {"data": make_dict_nparr(), "cast-to": "float", "digits": 1},
    }
