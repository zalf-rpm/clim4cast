...
def write_row_to_grids(row_col_data, row, ncols, header, path_to_output_dir, path_to_csv_output_dir, setup_id):
    ...
    output_grids = {
        ...
        "Pwp_S1": {"data": make_dict_nparr(), "cast-to": "float", "digits": 4},
        "Pwp_S2": {"data": make_dict_nparr(), "cast-to": "float", "digits": 4},
        "Pwp_S3": {"data": make_dict_nparr(), "cast-to": "float", "digits": 4},
        "Pwp_S4": {"data": make_dict_nparr(), "cast-to": "float", "digits": 4},
        "Pwp_S5": {"data": make_dict_nparr(), "cast-to": "float", "digits": 4},
        "Pwp_S6": {"data": make_dict_nparr(), "cast-to": "float", "digits": 4},
